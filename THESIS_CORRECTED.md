...
يُستخدم K-Means Clustering **مرة واحدة** على كامل توزيع صناديق الحقيقة
(Ground Truth) بمقياس مسافة (1 − IoU)، لتحديد أفضل أبعاد Anchors بدلاً من
...
*جدول (5-3): تحليل AP حسب حجم الجسم — v3*
...
متكرر بلا أي اهتزاز غير منطقي (flapping). *شكل (5-1): استجابة DIC لحمل
